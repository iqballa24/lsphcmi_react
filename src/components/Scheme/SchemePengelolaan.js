...
import { SKKNIPengelolaan } from "data/pdf";
...
const title = "Skema Pengelolaan Hubungan Industrial";

const desc =
  "Skema Pengelolaan Hubungan Industrial dengan menggunakan klaster kompetensi terdapat 8 unit kompetensi, sebagai berikut :";

const SchemePengelolaan = () => {
  return (
    <ScemeSection
      columnTable={column}
      dataTable={data}
      title={title}
      desc={desc}
      filePdf={SKKNIPengelolaan}
    />
  );
};

export default SchemePengelolaan;
